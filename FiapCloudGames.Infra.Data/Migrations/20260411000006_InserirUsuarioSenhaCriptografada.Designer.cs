...
namespace FiapCloudGames.Infra.Data.Migrations
{
    ...
    [Migration("20260411000006_InserirUsuarioSenhaCriptografada")]
    partial class InserirUsuarioSenhaCriptografada
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FiapCloudGames.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nome = "Admin",
                            PerfilId = (short)1,
                            Senha = "$2a$12$EDAGUpQWkCku4IoCMQBFg.9MeJtlL8iMdKyBQfkL0KpToNfaBkTAu",
                            Situacao = "\0"
                        });
                });
